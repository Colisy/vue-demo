    ...
    <div class="page-playController">
        <div id='playController'>
            ...
            <div class="play">
                ...
                <!-- 下载 -->
                <a :href='address+picture.audio_url'><button class="weui-btn" id='download' type="primary" plain="true">
                <img src='../img/logo.png' class='_logo' /> 下载这首歌
            </button></a>
            </div>
        </div>
        <!-- 背景 -->
    ...
    methods:{
        ...
        init(){
            let _id = window.location.hash.substring(window.location.hash.indexOf('=') + 1, window.location.hash.length),
                url = testing.address + "/index.php/api/song-detail/" + _id + "";
